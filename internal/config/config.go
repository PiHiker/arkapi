...
type Config struct {
	...
	HashCrackCostSats              int
	ScreenshotMaxWaitSeconds       int
	ScreenshotServiceURL           string
	ScreenshotServiceToken         string
	HashCrackServiceURL            string
	HashCrackServiceToken          string
	HashCrackMaxSeconds            int
...
func Load() Config {
	return Config{
		...
		HashCrackServiceURL:            getEnv("ARKAPI_HASH_CRACK_SERVICE_URL", "http://127.0.0.1:9021/crack"),
		HashCrackServiceToken:          getEnv("ARKAPI_HASH_CRACK_SERVICE_TOKEN", "change-me-hash-crack-token"),
		HashCrackMaxSeconds:            getEnvInt("ARKAPI_HASH_CRACK_MAX_SECONDS", 10),
