...
| GET | `/api/bitcoin-news` | 2 sats | Multi-source Bitcoin headlines with cross-feed dedupe and AI-assisted per-item sentiment |
...
| POST | `/api/ip-intel` | 6 sats | Combined IP geolocation, ASN context, abuse-desk RDAP contact when published, Google Maps link, AbuseIPDB reputation, and URLhaus host summary |
